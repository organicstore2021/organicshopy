{
    ...
    'version': '13.0.45.3',
    'category': 'Sales',
    'summary': 'Shopify Odoo Connector helps you in integrating and managing your Shopify store with Odoo by '
               'providing the most useful features of Product and Order Synchronization.',
    'license': 'OPL-1',
