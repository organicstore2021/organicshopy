...
class ShopifyInstanceConfig(models.TransientModel):
    ...
    def shopify_test_connection(self):
        ...
        shopify_instance.write({'shopify_global_channel_id': shopify_global_channel_id.id or False,'shopify_shipping_product_id':product_template.product_variant_ids[0].id})
...
class ResConfigSettings(models.TransientModel):
    ...
    #Shipping Product
    shopify_shipping_product_id = fields.Many2one("product.product", "Shipping Prpduct",
                                                  domain=[('type', '=', 'service')], required=False)
    shopify_gift_card_product_id = fields.Many2one('product.product', "Gift Card", domain=[('type', '=', 'service')])
    ...
    tip_product_id = fields.Many2one("product.product", "Tip Product",domain=[('type', '=', 'service')],
    ...
    def onchange_shopify_instance_id(self):
        ...
        if instance:
            ...
            self.shopify_shipping_product_id = instance.shopify_shipping_product_id and instance.shopify_shipping_product_id or False
            self.shopify_gift_card_product_id = instance.gift_card_product_id and instance.gift_card_product_id.id or False
...
#             mrp_module = module_obj.search([('name', '=', 'mrp'), ('state', '=', 'installed')])
            ...
            values['shopify_shipping_product_id'] = self.shopify_shipping_product_id.id or False
            values['gift_card_product_id'] = self.shopify_gift_card_product_id.id or False
